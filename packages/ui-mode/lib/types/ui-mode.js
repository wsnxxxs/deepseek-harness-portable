 ...
 */
export function asUiMode(value) {
 ...
 */
export function resolveUiMode(...candidates) {
 ...
 */
export function cycleUiMode(mode, direction = 1) {
 ...
 */
export function withUiModeParam(url, mode, base) {
 ...
 */
export function uiModeFromSearch(search) {
