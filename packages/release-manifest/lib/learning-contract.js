...
export const INTERACTIVE_LEARNING_PUBLIC_DECLARATION_FILES = [
    ...
    'lib/types/retrieval/index.d.ts',
    'lib/types/space/index.d.ts',
    'lib/types/space/manifest.d.ts',
