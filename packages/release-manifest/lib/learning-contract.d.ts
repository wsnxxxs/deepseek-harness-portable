...
export declare const INTERACTIVE_LEARNING_PACKAGE_FILES: readonly ["package.json", "cordis.patch.yml", "lib/index.js", "lib/bootstrap.js", "lib/preset.js", "preset/learning/preset.yml", "preset/learning/agent.cordis.yml", "lib/agent.js", "lib/client.js"];
/** Stable final-distribution additions materialized by the desktop packager. */
export declare const INTERACTIVE_LEARNING_DISTRIBUTION_FILES: readonly ["package.json", "cordis.patch.yml", "lib/index.js", "lib/bootstrap.js", "lib/preset.js", "preset/learning/preset.yml", "preset/learning/agent.cordis.yml", "lib/agent.js", "lib/client.js", "LICENSE"];
/** App-relative runtime files that register packaged experience-pack hosts. */
export declare const INTERACTIVE_LEARNING_APP_FILES: readonly ["lib/packaged-bin.js", "node_modules/@dsh-portable/desktop-protocol/cordis.patch.yml"];
/** Public declarations intentionally shipped by the Learning package. */
export declare const INTERACTIVE_LEARNING_PUBLIC_DECLARATION_FILES: readonly ["lib/types/agent.d.ts", "lib/types/bootstrap.d.ts", "lib/types/broker.d.ts", "lib/types/client/index.d.ts", "lib/types/client/lifecycle.d.ts", "lib/types/concept-cards.d.ts", "lib/types/concept-tools.d.ts", "lib/types/eval.d.ts", "lib/types/index.d.ts", "lib/types/index/chunker.d.ts", "lib/types/index/lexical.d.ts", "lib/types/ingest/index.d.ts", "lib/types/ingest/markdown.d.ts", "lib/types/ingest/pipeline.d.ts", "lib/types/ingest/provider.d.ts", "lib/types/ingest/text.d.ts", "lib/types/ingest/types.d.ts", "lib/types/installer.d.ts", "lib/types/learn-intent.d.ts", "lib/types/learner-memory.d.ts", "lib/types/learner-state.d.ts", "lib/types/learner-locale.d.ts", "lib/types/learning-reanchor.d.ts", "lib/types/material-anchor.d.ts", "lib/types/material-intake.d.ts", "lib/types/material-reanchor.d.ts", "lib/types/material-retrieval.d.ts", "lib/types/material-tools.d.ts", "lib/types/material-validation.d.ts", "lib/types/preset.d.ts", "lib/types/protocol-current.d.ts", "lib/types/protocol-errors.d.ts", "lib/types/protocol.d.ts", "lib/types/protocol-schema.d.ts", "lib/types/retrieval/index.d.ts", "lib/types/space/index.d.ts", "lib/types/space/manifest.d.ts", "lib/types/teaching-policy.d.ts", "lib/types/teaching-route.d.ts", "lib/types/topic-vault.d.ts"];
