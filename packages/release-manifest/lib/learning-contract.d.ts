...
export declare const INTERACTIVE_LEARNING_PUBLIC_DECLARATION_FILES: readonly ["lib/types/agent.d.ts", "lib/types/bootstrap.d.ts", "lib/types/broker.d.ts", "lib/types/client/VaultKeep.d.ts", "lib/types/client/VaultRoster.d.ts", "lib/types/client/VaultView.d.ts", "lib/types/client/vault-gate.d.ts", "lib/types/client/index.d.ts", "lib/types/client/lifecycle.d.ts", "lib/types/concept-cards.d.ts", "lib/types/concept-tools.d.ts", "lib/types/eval.d.ts", "lib/types/index.d.ts", "lib/types/ingest/index.d.ts", "lib/types/ingest/markdown.d.ts", "lib/types/ingest/pipeline.d.ts", "lib/types/ingest/text.d.ts", "lib/types/ingest/types.d.ts", "lib/types/installer.d.ts", "lib/types/learn-intent.d.ts", "lib/types/learner-memory.d.ts", "lib/types/learner-state.d.ts", "lib/types/learner-locale.d.ts", "lib/types/material-anchor.d.ts", "lib/types/material-intake.d.ts", "lib/types/material-reanchor.d.ts", "lib/types/material-retrieval.d.ts", "lib/types/material-tools.d.ts", "lib/types/material-validation.d.ts", "lib/types/preset.d.ts", "lib/types/protocol-current.d.ts", "lib/types/protocol-errors.d.ts", "lib/types/protocol.d.ts", "lib/types/protocol-schema.d.ts", "lib/types/teaching-policy.d.ts", "lib/types/teaching-route.d.ts", "lib/types/topic-vault.d.ts"];
