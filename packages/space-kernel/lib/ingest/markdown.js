 ...
 */
import { SOURCE_STRUCTURE_PROTOCOL, sectionIdOf, } from "./types.js";
 ...
 */
export function renderExtractedMarkdown(source) {
 ...
 */
export function emitSource(source, extractedPath) {
 ...
 */
export function deriveStructure(source, extractedPath, rendered = renderSource(source)) {
    const sections = [];
    const taken = new Map();
 ...
 */
export function reanchor(headingPath, quoteHash, structure) {
