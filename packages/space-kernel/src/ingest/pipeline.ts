...
import { runReanchorHooks } from '../reanchor-hooks.ts'
import type { ReanchorOutcome } from '../material-reanchor.ts'
import { chunkSource } from '../search/chunker.ts'
import { updateLexicalIndex, writeSourceChunks } from '../search/lexical.ts'
