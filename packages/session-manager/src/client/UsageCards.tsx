...
import type { SessionManagerKey, SessionManagerTranslate } from './locales.ts'
import {
  ACTIVITY_DAYS,
  ACTIVITY_WEEKS,
  USAGE_RANGES,
...
const TAB_LABELS: Record<UsageTab, SessionManagerKey> = {
  overview: 'usageCard.tabOverview',
  models: 'usageCard.tabModels',
}

const RANGE_LABELS: Record<UsageRange, SessionManagerKey> = {
  today: 'usageCard.rangeToday',
  '7d': 'usageCard.range7d',
  '30d': 'usageCard.range30d',
}

const COMPARISON_LABELS: Record<string, SessionManagerKey> = {
...
function modelLabel(row: ModelUsageRow, t: SessionManagerTranslate): string {
