...
export const PORTABLE_PLUGIN_ENDPOINTS = ['list', 'set-enabled'] as const
 ...
 */
export function isPortablePluginEndpoint(value: string): value is PortablePluginEndpoint {
  return (PORTABLE_PLUGIN_ENDPOINTS as readonly string[]).includes(value)
}
