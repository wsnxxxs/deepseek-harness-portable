...
| 项目 | 版本 |
| --- | --- |
| 发布 | DeepSeek Harness Desktop **v1.6.2**（[下载](https://github.com/wsnxxxs/deepseek-harness-portable/releases/tag/v1.6.2)) |
...
如需使用当前 1.6.2 产品版本身份生成一次性的 Windows x64 测试包，建议写入独立目录：
...
`dist-desktop/electron-v1.6.2-test/windows-artifacts/`；未压缩应用和已验证 bundle
也在同一输出目录下。
