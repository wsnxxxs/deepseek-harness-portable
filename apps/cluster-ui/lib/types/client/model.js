 ...
 */
/** A cleared form. */
export const EMPTY_DRAFT = { subject: '', description: '', blockers: '', scopes: '' };
/**
 ...
 */
export function memberStatusKey(status) {
    switch (status) {
 ...
 */
export function mutationError(result) {
    if (!result.ok)
 ...
 */
export function rootSessionId(sessionId, parentOf) {
