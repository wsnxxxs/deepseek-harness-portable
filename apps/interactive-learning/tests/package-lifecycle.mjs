...
try {
  ...
  assert.equal(sourceDeclarations.length, 20, 'source build must retain exactly 20 public declarations')
  assert.equal(sourceDeclarationMaps.length, 20, 'source build must retain exactly 20 public declaration maps')
