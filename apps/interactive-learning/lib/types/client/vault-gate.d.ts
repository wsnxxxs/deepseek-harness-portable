...
export declare const LEARNING_PRESET_ID = "learning";
 ...
 */
export declare function wantsVaultTabByPreset(row: GateSessionRow | undefined): boolean;
/**
 ...
 */
export declare function startVaultGate(options: VaultGateOptions): () => void;
//# sourceMappingURL=vault-gate.d.ts.map