 ...
 */
export declare function quoteHashOf(text: string): string;
/** SHA-256 of a source's original bytes; the skip-if-unchanged identity. */
export declare function contentHashOf(bytes: Uint8Array): string;
/**
 ...
 */
export declare function sectionIdOf(headingPath: readonly string[]): string;
/** Human-readable anchor text, the form that reaches `sourceAnchors`. */
export declare function formatAnchor(anchor: SourceAnchor): string;
