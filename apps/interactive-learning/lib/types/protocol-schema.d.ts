    ...
    readonly study_map: {
        ...
        readonly properties: {
            readonly kind: {
                ...
                readonly required: true;
                readonly description: "A navigable overview of a supplied document, chapter, slide deck, or multi-concept learning source. Preserve source sections and anchors instead of flattening the material.";
            };
