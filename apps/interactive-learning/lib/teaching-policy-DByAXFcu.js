...
//#endregion
export { labelFromBody as $, isLearnIntent as $t, ingestSource as A, ensureVaultLayout as At, executeRetrievalPlan as B, writeManifest as Bt, parseFileMentions as C, renderLearnerMemory as Ct, MAX_SOURCE_BYTES as D, VAULT_MANIFEST_PATH as Dt, beginMaterialTurn as E, VAULT_DIRECTORIES as Et, titleOf as F, resolveTopicVault as Ft, MAX_CONCEPT_CARDS as G, reanchor as Gt, matchedTerms as H, PAGE_MARKER as Ht, parseMarkdownBlocks as I, structurePathOf as It, conceptCardPathOf as J, LEARN_INTENT as Jt, buildConceptStudyMap as K, renderExtractedMarkdown as Kt, DEFAULT_RETRIEVAL_BUDGET_CHARS as L, upsertManifestEntry as Lt, SUPPORTED_EXTENSIONS as M, readAllStructures as Mt, extensionOf as N, readManifest as Nt, describeDegradation as O, VaultContainmentError as Ot, parseSource as P, readStructure as Pt, isConceptDue as Q, classifyLearnIntent as Qt, RETRIEVAL_INTENTS as R, vaultFromRoot as Rt, mentionedPaths as S, readLearnerMemory as St, assertMaterialAnchorsReadable as T, writeLearnerMemory as Tt, planRetrieval as U, deriveStructure as Ut, keyPhrases as V, EXTRACTED_HEADER as Vt, INITIAL_REVIEW_INTERVAL_DAYS as W, emitSource as Wt, dateKey as X, LEARN_INTENT_NATURAL_LANGUAGE_RULES as Xt, conceptRecordFromCard as Y, LEARN_INTENT_MODEL_GUIDANCE as Yt, hasFreshIndependentTransfer as Z, LEARN_INTENT_RULES as Zt, MAX_MAP_SECTIONS as _, MAX_RENDERED_CONCEPTS as _t, LEARNING_TEACHING_POLICY as a, reanchorConceptCards as at, registerMaterialTools as b, memoryPathOf as bt, buildLearningTeachingPolicy as c, reviewIntervalDays as ct, CONCEPT_TOOL_NAMES as d, updateConceptCardSchedule as dt, isLearningBoundary as en, nextReviewSchedule as et, registerConceptTools as f, yamlString as ft, MATERIAL_TOOL_NAMES as g, LEARNER_MEMORY_PROTOCOL as gt, validateStudyMapAgainstVault as h, reanchorVaultMemory as ht, LEARNING_REVIEW_POLICY as i, readLearnerMemoryWithCards as it, isSupportedSource as j, isVaultRoot as jt, ingestDirectory as k, containedPath as kt, routeLearningRequest as l, saveConceptCard as lt, formatStudyMapViolations as m, reanchorAnchorLists as mt, LEARNING_GRADED_POLICY as n, readConceptCard as nt, LEARNING_TEACHING_POLICY_CORE as o, recallCardIdOf as ot, validateRecallDeckAgainstVault as p, describeReanchor as pt, conceptCardDraftFromState as q, LEARNING_INTENT_POLICY as qt, LEARNING_MATERIAL_POLICY as r, readConceptCards as rt, LEARNING_VISUAL_POLICY as s, renderConceptCard as st, LEARNING_CHINESE_TEMPLATES as t, parseMarkdownFrontmatter as tt, routeLearningTurn as u, updateConceptCardAnchors as ut, MAX_READ_CHARS as v, MAX_STORED_CONCEPTS as vt, syncMentionedMaterial as w, upsertLearnerConcept as wt, sectionAnchor as x, parseLearnerConceptRecord as xt, MAX_SEARCH_MATCHES as y, conceptRecordFromState as yt, excerptAround as z, vaultRelative as zt };
