...
export const en = {
  ...
  'settings.memoryToggle': 'Enable history memory',
  'settings.memoryToggleBody': 'Allow this page to search reusable context from previous DSH sessions.',
  'settings.memoryConnected': 'History memory connected',
  'settings.memoryDisabled': 'History memory disabled',
  'settings.memoryDisabledBody': 'Turn on history memory to search previous sessions.',
  'settings.memorySearchPlaceholder': 'Search previous sessions',
  ...
  'settings.memoryHistoryNote': 'Results come from the DSH session history; resetting only clears this page.',
  'settings.memoryReset': 'Reset results',
...
export const zh: Record<DcodeKey, string> = {
  ...
  'settings.memoryToggle': '启用历史记忆',
  'settings.memoryToggleBody': '允许此页面从过去的 DSH 会话中检索可复用的上下文。',
  'settings.memoryConnected': '历史记忆已连接',
  'settings.memoryDisabled': '历史记忆已停用',
  'settings.memoryDisabledBody': '打开历史记忆后才能搜索之前的会话。',
  'settings.memorySearchPlaceholder': '搜索之前的会话',
  ...
  'settings.memoryHistoryNote': '结果来自 DSH 会话历史；重置只会清空本页结果。',
  'settings.memoryReset': '重置结果',
