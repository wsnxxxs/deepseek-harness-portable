...
export const en = {
  ...
  'settings.workspaceAndConnections': 'Workspace & connections',
  'settings.dataAndAbout': 'Data & about',
  'settings.workspaceAndConnectionsBody': 'Manage tools, extensions, and workspace-scoped integrations used by the workbench.',
...
export const zh: Record<DcodeKey, string> = {
  ...
  'settings.workspaceAndConnections': '工作区与连接',
  'settings.dataAndAbout': '数据与关于',
  'settings.workspaceAndConnectionsBody': '管理工作台使用的工具、扩展和工作区级连接。',
