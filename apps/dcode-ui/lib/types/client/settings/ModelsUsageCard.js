...
export function ModelsUsageCard({ useSessions, t }) {
    ...
    return (_jsxs("section", { className: classes.section, children: [_jsx("h2", { className: classes.title, children: t('settings.modelUsage') }), _jsx("p", { className: classes.intro, children: t('settings.modelUsageBody') }), _jsx(UsageCards, { list: list, t: t, styles: css })] }));
}
