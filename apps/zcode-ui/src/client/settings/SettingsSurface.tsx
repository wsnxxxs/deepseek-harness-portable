 ...
 * @module @dsh-portable/zcode-ui/client/settings/SettingsSurface
 */
...
const RAIL: readonly { group: ZcodeKey; items: readonly { id: SettingsSection; label: ZcodeKey }[] }[] = [
  {
  ...
  return (
    <Section title={t('settings.interface')} body={t('settings.interfaceBody')}>
      ...
      <div className={css.choice}>
        ...
        <button
          type="button"
          className={`${css.option} ${mode === 'zcode' ? css.optionActive : ''}`}
          onClick={() => { runtime.mode.set('zcode') }}
        >
